...
public class DatabaseFriend extends SQLiteOpenHelper {
        ...
        // Database Name
        private static final String DATABASE_NAME = "contactsMa";

        // Contacts table name
        private static final String TABLE_CONTACTS = "contac";
        ...
        public Friends getContact(int id) {
           ...
           Friends contact = new Friends(Integer.parseInt(cursor.getString(0)),
                    cursor.getString(1));
            // return contact
            return contact;
        }
        ...
        public void deleteContact(Friends contact) {
            SQLiteDatabase db = this.getWritableDatabase();
